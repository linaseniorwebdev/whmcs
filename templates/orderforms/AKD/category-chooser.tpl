<div class="text-center col-xs-12">
  <div class="choosecat btn-group">
    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> {$LANG.cartchooseanothercategory} <span class="caret"></span> </button>
